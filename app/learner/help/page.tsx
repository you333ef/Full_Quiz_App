...
const Help = () => {
  const handleMostaqlClick = () => {
    window.open("https://mostaql.com/u/yousef_khaled92", "_blank");
  };
    ...
    <div className="min-h-screen bg-white p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-white text-black p-8 rounded-lg shadow-xl border border-gray-200 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start mb-6">
              <FaComments className="text-3xl mr-4" />
              <h2 className="text-2xl font-bold">Contact Methods</h2>
            </div>
            <div
              onClick={handleMostaqlClick}
            ...
            >
              ...
              <div className="ml-4">
                <p className="font-semibold hidden md:block">Via Mostaql</p>
                <p className="text-sm text-gray-600">yousef_khaled92</p>
              </div>
            </div>
          </div>
        </div>
