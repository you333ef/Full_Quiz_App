    ...
    <div >
      ...
      <div  >
        <div className="flex justify-end overflow-hidden">
           <button onClick={()=>SetOpen(true)} className="flex items-center gap-2 border border-gray-300 px-3 md:px-4 py-1.5 rounded-full hover:bg-gray-100 transition text-xs md:text-sm font-medium">
